...
var SelectValue$1 = reactExports.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.span, {
    ...
    children: shouldShowPlaceholder(context.value)
      ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: placeholder })
      : children,
  });
});
      ...
      ? reactDomExports.createPortal(
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContentProvider, {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection.Slot, {
              scope: props.__scopeSelect,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: props.children }),
            }),
          }),
          frag,
        )
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      ...
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren
        ? reactDomExports.createPortal(itemTextProps.children, context.valueNode)
        : null,
    ],
  });
});
...
const SelectScrollUpButton = reactExports.forwardRef(({ className, ...props }, ref) =>
...
const SelectScrollDownButton = reactExports.forwardRef(({ className, ...props }, ref) =>
...
const SelectItem = reactExports.forwardRef(({ className, children, ...props }, ref) =>
...
const SelectSeparator = reactExports.forwardRef(({ className, ...props }, ref) =>
