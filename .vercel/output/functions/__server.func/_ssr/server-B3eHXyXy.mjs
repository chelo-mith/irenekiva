...
function ClientOnly({ children, fallback = null }) {
  return useHydrated()
    ...
    : /* @__PURE__ */ jsxRuntimeExports.jsx(React2.Fragment, { children: fallback });
}
    ...
    try {
      ...
      const executeRouter = async (serverContext, matchedRoutes) => {
        ...
        const responseLinkHeaderEntries =
          shouldCollectEarlyHints && responseLinkHeader ? new Array() : void 0;
        const responseLinkHeaderFilter = shouldCollectEarlyHints
          ? getResponseLinkHeaderFilter(responseLinkHeader)
          : void 0;
        if (shouldCollectEarlyHints && sentEarlyHintLinks && matchedRoutes?.length)
