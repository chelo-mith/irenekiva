import { r as k, j as ae, f as Ue } from "./index-CIHZH9WC.js";
function ye(e, t) {
...
function Ko(...e) {
  return k.useCallback(Re(...e), e);
}
var Ye = Symbol.for("react.lazy"),
  K = Ue[" use ".trim().toString()];
function qe(e) {
...
function He(e) {
  const t = Ze(e),
    o = k.forwardRef((r, n) => {
      ...
      const u = k.Children.toArray(s),
        f = u.find(Ke);
      if (f) {
        const c = f.props.children,
          b = u.map((g) =>
            g === f
              ? k.Children.count(c) > 1
        ...
        return ae.jsx(t, {
          ...l,
          ref: n,
          children: k.isValidElement(c) ? k.cloneElement(c, void 0, b) : null,
        });
      }
      return ae.jsx(t, { ...l, ref: n, children: s });
    });
  return ((o.displayName = `${e}.Slot`), o);
}
var Xe = He("Slot");
function Ze(e) {
  const t = k.forwardRef((o, r) => {
    let { children: n, ...s } = o;
    if ((Ie(n) && typeof K == "function" && (n = K(n._payload)), k.isValidElement(n))) {
      const l = eo(n),
        u = Qe(s, n.props);
      return (n.type !== k.Fragment && (u.ref = r ? Re(r, l) : l), k.cloneElement(n, u));
    }
...
function je() {
  for (var e, t, o = 0, r = "", n = arguments.length; o < n; o++)
    (e = arguments[o]) && (t = Pe(e)) && (r && (r += " "), (r += t));
  return r;
}
const xe = (e) => (typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e),
  ke = je,
  oo = (e, t) => (o) => {
    var r;
    ...
    const { variants: n, defaultVariants: s } = t,
      ...
      u =
        o &&
        Object.entries(o).reduce((c, b) => {
          let [g, z] = b;
          return (z === void 0 || (c[g] = z), c);
        }, {}),
      f =
        t == null || (r = t.compoundVariants) === null || r === void 0
          ? void 0
          : r.reduce((c, b) => {
              let { class: g, className: z, ...R } = b;
              return Object.entries(R).every((N) => {
                let [x, w] = N;
                return Array.isArray(w) ? w.includes({ ...s, ...u }[x]) : { ...s, ...u }[x] === w;
              })
                ? [...c, g, z]
                : c;
            }, []);
    return ke(e, l, f, o?.class, o?.className);
  },
  ro = (e, t) => {
  ...
  to = (e, t) => ({ classGroupId: e, validator: t }),
  Ge = (e = new Map(), t = null, o) => ({ nextPart: e, validators: t, classGroupId: o }),
  Q = "-",
  we = [],
  no = "arbitrary..",
  so = (e) => {
    ...
    return {
      getClassGroupId: (l) => {
        if (l.startsWith("[") && l.endsWith("]")) return ao(l);
        const u = l.split(Q),
  ...
  uo = (e, t, o, r) => {
    ...
    (t.validators === null && (t.validators = []), t.validators.push(to(o, e)));
  },
  po = (e, t, o, r) => {
  ...
  bo = (e) => {
    ...
    const n = (s, l) => {
      ((o[s] = l), t++, t > e && ((t = 0), (r = o), (o = Object.create(null))));
    };
    return {
      get(s) {
        let l = o[s];
  ...
  ho = (e) => {
    ...
    let r = (n) => {
      ...
      const g = s.length === 0 ? n : n.slice(f);
      let z = g,
        R = !1;
      g.endsWith(ie)
        ? ((z = g.slice(0, -1)), (R = !0))
        : g.startsWith(ie) && ((z = g.slice(1)), (R = !0));
      const N = c && c > f ? c - f : void 0;
      return Ce(s, R, z, N);
    };
    if (t) {
      const n = t + ve,
        s = r;
      r = (l) => (l.startsWith(n) ? s(l.slice(n.length)) : Ce(go, !1, l, void 0, !0));
    }
    if (o) {
      const n = r;
      ...
      (o) => {
        ...
        for (let s = 0; s < o.length; s++) {
          const l = o[s],
            u = l[0] === "[",
            f = t.has(l);
          u || f ? (n.length > 0 && (n.sort(), r.push(...n), (n = [])), r.push(l)) : n.push(l);
        }
  ...
  xo = (e) => ({
    ...
    parseClassName: ho(e),
    sortModifiers: yo(e),
    postfixLookupClassGroupIds: ko(e),
    ...so(e),
  }),
  ko = (e) => {
  ...
  vo = (e, t) => {
    ...
    for (let b = f.length - 1; b >= 0; b -= 1) {
      ...
      let T = !!w,
        S;
      if (T) {
        const j = x.substring(0, w);
        S = r(j);
        const d = S && l[S] ? r(x) : void 0;
        d && d !== S && ((S = d), (T = !1));
      } else S = r(x);
      if (!S) {
        if (!T) {
      ...
      const $ = R.length === 0 ? "" : R.length === 1 ? R[0] : s(R).join(":"),
        _ = N ? $ + ie : $,
        W = _ + S;
  ...
  Co = (...e) => {
    let t = 0,
      ...
      r,
      n = "";
    for (; t < e.length; ) (o = e[t++]) && (r = Ne(o)) && (n && (n += " "), (n += r));
    return n;
  },
  Ne = (e) => {
    ...
    let t,
      o = "";
    for (let r = 0; r < e.length; r++) e[r] && (t = Ne(e[r])) && (o && (o += " "), (o += t));
    return o;
  },
  zo = (e, ...t) => {
    let o, r, n, s;
    const l = (f) => {
        const c = t.reduce((b, g) => g(b), e());
        return ((o = xo(c)), (r = o.cache.get), (n = o.cache.set), (s = u), u(f));
      },
      u = (f) => {
        const c = r(f);
        if (c) return c;
  ...
  se = (e) => e.endsWith("%") && p(e.slice(0, -1)),
  G = (e) => Ro.test(e),
  Oe = () => !0,
  Eo = (e) => Io.test(e) && !Po.test(e),
  ce = () => !1,
  Mo = (e) => jo.test(e),
  No = (e) => Go.test(e),
  To = (e) => !a(e) && !i(e),
  ...
  Le = (e) => e === "position" || e === "percentage",
  _e = (e) => e === "image" || e === "url",
  We = (e) => e === "length" || e === "size" || e === "bg-size",
  Be = (e) => e === "length",
  Uo = (e) => e === "number",
  Fe = (e) => e === "family-name",
  $e = (e) => e === "number" || e === "weight",
  De = (e) => e === "shadow",
  Yo = () => {
    const e = h("color"),
      t = h("font"),
      ...
      d = () => [i, a, f],
      A = () => [E, "full", "auto", ...d()],
      de = () => [P, "none", "subgrid", i, a],
      me = () => ["auto", { span: ["full", P, i, a] }, P, i, a],
      U = () => [P, "auto", i, a],
      ...
      oe = () => [E, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...d()],
      re = () => [E, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...d()],
      m = () => [e, i, a],
      pe = () => [..._(), Ae, Se, { position: [i, a] }],
      fe = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      be = () => ["auto", "cover", "contain", Fo, Oo, { size: [i, a] }],
      te = () => [se, D, O],
      v = () => ["", "none", "full", c, i, a],
      C = () => ["", p, D, O],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", E, a, i, w] }],
        container: ["container"],
        "container-type": [{ "@container": ["", "normal", "size", i, a] }],
        "container-named": [Vo],
        columns: [{ columns: [p, a, i, u] }],
        ...
        z: [{ z: [P, "auto", i, a] }],
        basis: [{ basis: [E, "full", "auto", u, ...d()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [p, E, "auto", "initial", "none", a] }],
        grow: [{ grow: ["", p, i, a] }],
        shrink: [{ shrink: ["", p, i, a] }],
        order: [{ order: [P, "first", "last", "none", i, a] }],
        ...
        w: [{ w: [u, "screen", ...V()] }],
        "min-w": [{ "min-w": [u, "screen", "none", ...V()] }],
        "max-w": [{ "max-w": [u, "screen", "none", "prose", { screen: [l] }, ...V()] }],
        h: [{ h: ["screen", "lh", ...V()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...V()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...V()] }],
        "font-size": [{ text: ["base", o, D, O] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [r, Do, Lo] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "line-clamp": [{ "line-clamp": [p, "none", i, ze] }],
        leading: [{ leading: [s, ...d()] }],
        ...
        "text-decoration-thickness": [{ decoration: [p, "from-font", "auto", i, O] }],
        "text-decoration-color": [{ decoration: m() }],
        "underline-offset": [{ "underline-offset": [p, "auto", i, a] }],
        ...
        "bg-image": [
          {
            bg: [
              "none",
              {
                linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, P, i, a],
                radial: ["", i, a],
                conic: [P, i, a],
              },
              $o,
        ...
        "border-w-bs": [{ "border-bs": C() }],
        "border-w-be": [{ "border-be": C() }],
        ...
        "outline-offset": [{ "outline-offset": [p, i, a] }],
        "outline-w": [{ outline: ["", p, D, O] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", z, J, Z] }],
        "text-shadow-color": [{ "text-shadow": m() }],
        opacity: [{ opacity: [p, i, a] }],
        ...
        blur: [{ blur: he() }],
        brightness: [{ brightness: [p, i, a] }],
        contrast: [{ contrast: [p, i, a] }],
        "drop-shadow": [{ "drop-shadow": ["", "none", R, J, Z] }],
        "drop-shadow-color": [{ "drop-shadow": m() }],
        grayscale: [{ grayscale: ["", p, i, a] }],
        "hue-rotate": [{ "hue-rotate": [p, i, a] }],
        invert: [{ invert: ["", p, i, a] }],
        saturate: [{ saturate: [p, i, a] }],
        sepia: [{ sepia: ["", p, i, a] }],
        "backdrop-filter": [{ "backdrop-filter": ["", "none", i, a] }],
        "backdrop-blur": [{ "backdrop-blur": he() }],
        "backdrop-brightness": [{ "backdrop-brightness": [p, i, a] }],
        "backdrop-contrast": [{ "backdrop-contrast": [p, i, a] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": ["", p, i, a] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [p, i, a] }],
        "backdrop-invert": [{ "backdrop-invert": ["", p, i, a] }],
        "backdrop-opacity": [{ "backdrop-opacity": [p, i, a] }],
        "backdrop-saturate": [{ "backdrop-saturate": [p, i, a] }],
        "backdrop-sepia": [{ "backdrop-sepia": ["", p, i, a] }],
        ...
        duration: [{ duration: [p, "initial", i, a] }],
        ease: [{ ease: ["linear", "initial", T, i, a] }],
        delay: [{ delay: [p, i, a] }],
        animate: [{ animate: ["none", S, i, a] }],
        backface: [{ backface: ["hidden", "visible"] }],
        perspective: [{ perspective: [x, i, a] }],
...
const Xo = oo(
  ...
  Zo = k.forwardRef(({ className: e, variant: t, size: o, asChild: r = !1, ...n }, s) => {
    const l = r ? Xe : "button";
    return ae.jsx(l, { className: Ho(Xo({ variant: t, size: o, className: e })), ref: s, ...n });
  });
Zo.displayName = "Button";
export { Zo as B, Re as a, Xo as b, Ho as c, oo as d, He as e, Ko as u };
