import { r as n, j as a, e as Re } from "./index-CIHZH9WC.js";
import {
  e as _,
  k as ht,
  u as be,
...
import { a as Pt, u as L, c as G } from "./button-m6WrSBHU.js";
import { c as Pe } from "./createLucideIcon-BcyvzURP.js";
import { C as _t } from "./check-CV6Ntlop.js";
const jt = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]],
  _e = Pe("chevron-down", jt);
const Mt = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]],
  At = Pe("chevron-up", Mt);
function Ne(t, [o, e]) {
  ...
  const o = Dt(t),
    e = n.forwardRef((s, r) => {
      const { children: d, ...l } = s,
        c = n.Children.toArray(d),
        i = c.find(Vt);
      if (i) {
        const p = i.props.children,
          g = c.map((x) =>
            x === i
...
function Dt(t) {
  const o = n.forwardRef((e, s) => {
    ...
    if (n.isValidElement(r)) {
      const l = Bt(r),
        c = kt(d, r.props);
      return (r.type !== n.Fragment && (c.ref = s ? Pt(s, l) : l), n.cloneElement(r, c));
    }
...
var je = Object.freeze({
  ...
  Wt = "VisuallyHidden",
  Ft = n.forwardRef((t, o) => a.jsx(_.span, { ...t, ref: o, style: { ...je, ...t.style } }));
Ft.displayName = Wt;
var Ut = [" ", "Enter", "ArrowUp", "ArrowDown"],
  Kt = [" ", "Enter"],
  Q = "Select",
  [ie, de, $t] = vt(Q),
  [oe] = wt(Q, [$t, Ee]),
  ...
  Me = (t) => {
    const {
      ...
      [F, M] = n.useState(!1),
      ne = ht(p),
      [E, O] = be({ prop: s, defaultProp: r ?? !1, onChange: d, caller: Q }),
      [U, Z] = be({ prop: l, defaultProp: c, onChange: i, caller: Q }),
      V = n.useRef(null),
        ...
        children: [
          a.jsx(ie.Provider, {
            ...
            children: a.jsx(Gt, {
              ...
              onNativeOptionAdd: n.useCallback((P) => {
                B((D) => new Set(D).add(P));
              }, []),
              onNativeOptionRemove: n.useCallback((P) => {
                B((D) => {
                  const W = new Set(D);
                  return (W.delete(P), W);
                });
  ...
  Oe = n.forwardRef((t, o) => {
    ...
    return a.jsx(xt, {
      ...
      children: a.jsx(_.button, {
        ...
        "data-placeholder": nt(l.value) ? "" : void 0,
        ...r,
        ref: i,
        ...
        onKeyDown: N(r.onKeyDown, (u) => {
          ...
          (!(u.ctrlKey || u.altKey || u.metaKey) && u.key.length === 1 && R(u.key),
            !(h && u.key === " ") && Ut.includes(u.key) && (C(), u.preventDefault()));
        }),
      }),
    });
  });
...
var De = "SelectValue",
  Le = n.forwardRef((t, o) => {
    const { __scopeSelect: e, className: s, style: r, children: d, placeholder: l = "", ...c } = t,
      i = Y(De, e),
      { onValueNodeHasChildrenChange: p } = i,
      g = d !== void 0,
      x = L(o, i.onValueNodeChange);
    return (
      z(() => {
        p(g);
      }, [p, g]),
      a.jsx(_.span, {
        ...
        children: nt(i.value) ? a.jsx(a.Fragment, { children: l }) : d,
      })
    );
  });
Le.displayName = De;
...
var ee = "SelectContent",
  Be = n.forwardRef((t, o) => {
    ...
    return a.jsx(We, { ...t, ref: o });
  });
Be.displayName = ee;
var A = 10,
  [He, q] = oe(ee),
  Xt = "SelectContentImpl",
  Jt = Ot("SelectContent.RemoveScroll"),
  We = n.forwardRef((t, o) => {
    const {
        __scopeSelect: e,
            ...
            children: a.jsx(le, {
              ...
              onKeyDown: N(S.onKeyDown, (f) => {
                ...
                if (
                  ...
                  (setTimeout(() => P(w)), f.preventDefault());
                }
              }),
            }),
          }),
...
var Qt = "SelectItemAlignedPosition",
  Fe = n.forwardRef((t, o) => {
    const { __scopeSelect: e, onPlaced: s, ...r } = t,
      ...
      v = n.useCallback(() => {
        if (d.trigger && d.valueNode && c && p && u && h && S) {
          ...
          if (I <= te) {
            ...
            ((c.style.height = X + "px"), (u.scrollTop = I - te + u.offsetTop));
          }
          ((c.style.margin = `${A}px 0`),
            (c.style.minHeight = pe + "px"),
            (c.style.maxHeight = k + "px"),
            s?.(),
            requestAnimationFrame(() => (T.current = !0)));
        }
      }, [R, d.trigger, d.valueNode, c, p, u, h, S, d.dir, s]);
    z(() => v(), [v]);
        ...
        a.jsx(ie.Slot, {
          ...
          children: a.jsx(_.div, {
            ...
            onScroll: N(r.onScroll, (p) => {
              ...
              if (R?.current && x) {
                const T = Math.abs(i.current - g.scrollTop);
                if (T > 0) {
...
var ce = "SelectItem",
  ...
  Ye = n.forwardRef((t, o) => {
    const { __scopeSelect: e, value: s, disabled: r = !1, textValue: d, ...l } = t,
      ...
      [g, x] = n.useState(d ?? ""),
      [R, T] = n.useState(!1),
      C = L(o, (m) => i.itemRefCallback?.(m, s, r)),
      u = Ie(),
      h = n.useRef("touch"),
      S = () => {
        ...
        children: a.jsx(_.div, {
          ...
          onKeyDown: N(l.onKeyDown, (m) => {
            (i.searchRef?.current !== "" && m.key === " ") ||
              (Kt.includes(m.key) && S(), m.key === " " && m.preventDefault());
          }),
        }),
      }),
    });
...
var se = "SelectItemText",
  qe = n.forwardRef((t, o) => {
    const { __scopeSelect: e, className: s, style: r, ...d } = t,
      ...
      T = g?.textContent,
      C = n.useMemo(
        () => a.jsx("option", { value: i.value, disabled: i.disabled, children: T }, i.value),
    ...
    return (
      ...
      a.jsxs(a.Fragment, {
        children: [
          a.jsx(_.span, { id: i.textId, ...d, ref: R }),
          i.isSelected && l.valueNode && !l.valueNodeHasChildren
...
qe.displayName = se;
var Ze = "SelectItemIndicator",
  Xe = n.forwardRef((t, o) => {
    const { __scopeSelect: e, ...s } = t;
    return Ge(Ze, e).isSelected ? a.jsx(_.span, { "aria-hidden": !0, ...s, ref: o }) : null;
  });
Xe.displayName = Ze;
...
var Ce = "SelectArrow",
  lo = n.forwardRef((t, o) => {
    const { __scopeSelect: e, ...s } = t,
      ...
      d = Y(Ce, e),
      l = q(Ce, e);
    return d.open && l.position === "popper" ? a.jsx(Et, { ...r, ...s, ref: o }) : null;
  });
lo.displayName = Ce;
var co = "SelectBubbleInput",
  ot = n.forwardRef(({ __scopeSelect: t, value: o, ...e }, s) => {
    ...
    return (
      n.useEffect(() => {
        ...
        const i = window.HTMLSelectElement.prototype,
          g = Object.getOwnPropertyDescriptor(i, "value").set;
        if (l !== o && g) {
          const x = new Event("change", { bubbles: !0 });
          (g.call(c, o), c.dispatchEvent(x));
        }
      }, [l, o]),
      a.jsx(_.select, { ...e, style: { ...je, ...e.style }, ref: d, defaultValue: o })
    );
  });
ot.displayName = co;
function nt(t) {
        ...
        (o(c),
          (function i(p) {
            ((e.current = p),
              ...
              p !== "" && (s.current = window.setTimeout(() => i(""), 1e3)));
          })(c));
      },
      [o],
    ),
...
function st(t, o, e) {
  const r = o.length > 1 && Array.from(o).every((p) => p === o[0]) ? o[0] : o,
    d = e ? t.indexOf(e) : -1;
  let l = io(t, Math.max(d, 0));
  r.length === 1 && (l = l.filter((p) => p !== e));
  const i = l.find((p) => p.textValue.toLowerCase().startsWith(r.toLowerCase()));
  return i !== e ? i : void 0;
}
function io(t, o) {
...
const Eo = uo,
  Po = po,
  xo = n.forwardRef(({ className: t, children: o, ...e }, s) =>
    a.jsxs(at, {
      ref: s,
      className: G(
      ...
      children: [
        o,
        a.jsx(fo, { asChild: !0, children: a.jsx(_e, { className: "h-4 w-4 opacity-50" }) }),
      ],
    }),
  );
xo.displayName = at.displayName;
const ft = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(dt, {
    ref: e,
    className: G("flex cursor-default items-center justify-center py-1", t),
    ...o,
    children: a.jsx(At, { className: "h-4 w-4" }),
  }),
);
ft.displayName = dt.displayName;
const mt = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(ut, {
    ref: e,
    className: G("flex cursor-default items-center justify-center py-1", t),
    ...o,
    children: a.jsx(_e, { className: "h-4 w-4" }),
  }),
);
mt.displayName = ut.displayName;
const So = n.forwardRef(({ className: t, children: o, position: e = "popper", ...s }, r) =>
  a.jsx(mo, {
    children: a.jsxs(lt, {
      ref: r,
      className: G(
...
So.displayName = lt.displayName;
const wo = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(ct, { ref: e, className: G("px-2 py-1.5 text-sm font-semibold", t), ...o }),
);
wo.displayName = ct.displayName;
const yo = n.forwardRef(({ className: t, children: o, ...e }, s) =>
  a.jsxs(it, {
    ref: s,
    className: G(
    ...
    children: [
      a.jsx("span", {
        ...
        children: a.jsx(vo, { children: a.jsx(_t, { className: "h-4 w-4" }) }),
      }),
      a.jsx(go, { children: o }),
    ],
  }),
...
const Co = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(pt, { ref: e, className: G("-mx-1 my-1 h-px bg-muted", t), ...o }),
);
Co.displayName = pt.displayName;
export { Eo as S, xo as a, Po as b, So as c, yo as d, Ht as u };
